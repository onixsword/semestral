  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('index')}}"><img src="/images/logo.jpeg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('index')}}"><img src="/images/logo-mini.jpeg" alt="logo"/></a>
      </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('componentes.index')}}">Componentes</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('marcas.index')}}">Marca</a></li>
